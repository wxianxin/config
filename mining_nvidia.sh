...
sudo nvidia-smi -lgc 1250,1260 # --lock-gpu-clocks=MIN_GPU_CLOCK,MAX_GPU_CLOCK
...
NVIDIA_MEM_OFFSET=660
NVIDIA_CLOCK_OFFSET=-600
...
########################################################################################
~/Downloads/nanominer-linux-3.3.13-cuda11/nanominer ~/Downloads/nanominer-linux-3.3.13-cuda11/config.ini
